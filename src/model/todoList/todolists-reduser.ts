...
export const createTodolistAC = createAction<{ newTodo: TodoType }>("todolists/createTodolist")
export const deleteTodolistAC = createAction<{ todoId: string }>("todolists/deleteTodolist")
export const updateTodolistTitleAC = createAction<{ todoId: string, title: string }>("todolists/updateTodolistTitle")
